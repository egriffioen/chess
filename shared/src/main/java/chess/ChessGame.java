...
public class ChessGame {
    ...
    public void makeMove(ChessMove move) throws InvalidMoveException {
        ...
        if (validMoves.contains(move)&&piece.getTeamColor()==teamColorTurn) {
            ...
            if (piece.getTeamColor()!=teamColorTurn) {
                throw new InvalidMoveException("Piece is of the other team's color");
            }
...
/**
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(board, chessGame.board) && teamColorTurn == chessGame.teamColorTurn;
    }

    @Override
    public int hashCode() {
        return Objects.hash(board, teamColorTurn);
    }
